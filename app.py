...
MODELS = {
    "Deepseek1": "deepseek-r1:1.5b",
    "Deepseek2": "deepseek-r1:8b",
    "Llama1": "llama3.2:1b",
    "Llama2": "llama3.2:3b",
}
...
if "model" not in st.session_state:
    st.session_state.model = MODELS["Deepseek1"]
...
page = st.sidebar.selectbox("Menu", ["Home", "Deepseek1", "Deepseek2", "Llama1", "Llama2"])
if page != "Home":
